...
// console.log("endYear",endYear)
    ...
    const startDate = new Date(startYear, 0, 1); // 1er janvier de l'année de début
    const endDate = new Date(endYear + 1, 0, 1); // 1er janvier de l'année suivante à l'année de fin
    ...
    console.log("totalHtRevenue",totalHtRevenue)
